...
C:\Users\avani\LeadPilot_DDoxers_2026\.venv\Scripts\python.exe -c "import sys; sys.path.insert(0, 'C:/Users/avani/LeadPilot_DDoxers_2026'); import os; os.chdir('C:/Users/avani/LeadPilot_DDoxers_2026/lead_finder'); import click; from __main__ import main; main(['--port', '8081'])"
pause
